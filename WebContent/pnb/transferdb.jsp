 ...
 try{
   ...
   try
          ...
          // con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","12345");
           ps=con.prepareStatement("select * from pnb where ACCNO='"+accno+"' AND PASS='"+pass+"'");
            rs=ps.executeQuery();
           if(rs.next())
           {
	  ...
	  Statement stmt = null;
	   ...
	   String sql = "update pnb set AMOUNT='"+amt+"' where ACCNO='"+accno+"' and PASS='"+pass+"'";
  ...
  try
          {
           //con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","12345");
           ps=con.prepareStatement("select AMOUNT from pnb where ACCNO='"+taccno+"'");
            rs=ps.executeQuery();
           if(rs.next())
           {
  ...
  String sql1 = "update pnb set AMOUNT='"+tamt+"' where ACCNO='"+taccno+"'";
  stmt1.executeUpdate(sql1);
           ...
           // rs=ps.executeQuery();
            ...
            out.println("<img src='images/pnb.jpg' alt='LOGO' style='width:1350px; height:170px;'>");
