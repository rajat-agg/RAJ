<html>
   ...
   if(!isNaN(document.F1.amount.value))
   {
	   ...
	   {
		 alert("Minimum Amount should be Rs500/-");
   ...
   return true;
    ...
    <body background="images/back.jpg">
        <img alt=""  src="images/allahabad.jpg" style="width:1350px; height:200px;">
          <br>
        <div id="navigation">
    <ul>
        <li><a href="allah_home.jsp">HOME</a></li>
    ...
    <div>
        <fieldset>
            <legend><b>Credit money into your account</b></legend>
            <div><font color="red">
                <%if(request.getAttribute("depositdb")!=null)
			{
			out.print(request.getAttribute("depositdb"));
			}
			
			 %>
                         </font>
            </div>
                         <form name=F1 onSubmit="return validate(this)" action="depositdb.jsp" method="post">
                <table>
                    <tr>
                        <td>
                            <b> Account number:</b>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="amount" placeholder="enter amount"><font size="1px">*should be atleast Rs500/-</font>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
