...
function validate(form)
{
   ...
   return true;
    ...
    <div>
        <fieldset>
            <legend><b>Check Your Current Balance</b></legend>
            <div><font color="red">
                <%if(request.getAttribute("checkbaldb")!=null)
			{
			out.print(request.getAttribute("checkbaldb"));
			}
			
			 %>
                         </font>
            </div>
            <form name=F1 onSubmit="return validate(this)" action="checkbaldb.jsp" method="post">
                <table>
                    <tr>
                        <td>
                            <b> Account number:</b>
