 ...
 try{
   ...
   try
          ...
          // con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","12345");
           ps=con.prepareStatement("select * from canara where ACCNO='"+accno+"' AND PASS='"+pass+"'");
            rs=ps.executeQuery();
           if(rs.next())
           {
	  ...
	  Statement stmt = null;
	   ...
	   String sql = "update canara set AMOUNT='"+amt+"' where ACCNO='"+accno+"' and PASS='"+pass+"'";
  ...
  try
          {
           //con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","12345");
           ps=con.prepareStatement("select AMOUNT from canara where ACCNO='"+taccno+"'");
            rs=ps.executeQuery();
           if(rs.next())
           {
  ...
  String sql1 = "update canara set AMOUNT='"+tamt+"' where ACCNO='"+taccno+"'";
  stmt1.executeUpdate(sql1);
           ...
           // rs=ps.executeQuery();
            ...
            out.println("<img src='images/canara.jpg' alt='LOGO' style='width:1350px; height:170px;'>");
