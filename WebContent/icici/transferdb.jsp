 ...
 try{
   ...
   try
          ...
          // con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","12345");
           ps=con.prepareStatement("select * from icici where ACCNO='"+accno+"' AND PASS='"+pass+"'");
            rs=ps.executeQuery();
           if(rs.next())
           {
	  ...
	  Statement stmt = null;
	   ...
	   String sql = "update icici set AMOUNT='"+amt+"' where ACCNO='"+accno+"' and PASS='"+pass+"'";
  ...
  try
          {
           //con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","12345");
           ps=con.prepareStatement("select AMOUNT from icici where ACCNO='"+taccno+"'");
            rs=ps.executeQuery();
           if(rs.next())
           {
  ...
  String sql1 = "update icici set AMOUNT='"+tamt+"' where ACCNO='"+taccno+"'";
