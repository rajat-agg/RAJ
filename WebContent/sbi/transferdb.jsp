 ...
 try{
   ...
   try
          ...
          // con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","12345");
           ps=con.prepareStatement("select * from sbi where ACCNO='"+accno+"' AND PASS='"+pass+"'");
            rs=ps.executeQuery();
           if(rs.next())
           {
	  ...
	  Statement stmt = null;
	   ...
	   String sql = "update sbi set AMOUNT='"+amt+"' where ACCNO='"+accno+"' and PASS='"+pass+"'";
  ...
  try
          {
           //con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","12345");
           ps=con.prepareStatement("select AMOUNT from sbi where ACCNO='"+taccno+"'");
            rs=ps.executeQuery();
           if(rs.next())
           {
  ...
  String sql1 = "update sbi set AMOUNT='"+tamt+"' where ACCNO='"+taccno+"'";
  stmt1.executeUpdate(sql1);
           ...
           // rs=ps.executeQuery();
            ...
            out.println("<img src='images/sbi.jpg' alt='LOGO' style='width:1350px; height:170px;'>");
